...
router.get('/api/profil', async function(req, res) {
  ...
  .then(async function (response) {
    ...
    set(ref(getDatabase(), global.user+'/mycards/card/'),(""));
    set(ref(getDatabase(), global.user+'/myauctions/auction'), (""));
    set(ref(getDatabase(), global.user+'/mydirectoffers'), (""));
    set(ref(getDatabase(), global.user+'/mycards/nombreCards'), (nbRarityCards));
    set(ref(getDatabase(), global.user+'/profil/watching/totalWallet'),(userWallet.currentUser.totalBalance/Math.pow(10,18)));
    set(ref(getDatabase(), global.user+'/profil/lastRefresh'),(Date()));
    ...
    // #####################################
    // paginatedCards(first:300)############
    get(child(dbRef, global.user+'/mycards/lockedprice')).then((snapshot) => {
    if (snapshot.exists()) {
    ...
    for (let i=0;i<nbCardqRarity;i++){
      ...
      if(global.cardsLockArray!= undefined && global.cardsLockArray.includes(global.cardslug)){
        ...
        set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/locked'),("lock"));
        set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/priceAchat'),(global.cardsLockArray[findIndex]));
  
      }else{
        set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/locked'),(global.lock));
        set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/priceAchat'),(global.priceAchat));
      };
  
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/playername'),(playername));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/age'),(age));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/position'),(position));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/dateAchat'),(dateAchat));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/Url'),(Url));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/rarete'),(rarity));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/cardslug'),(global.cardslug));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/onSale'),(getOnSale));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/grade'),(grade));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/xp'),(xp));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/playerslug'),(playerslug));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/transferType'),(transferType));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/league'),(global.leagueslug));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/competition'),(global.competition));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/lastValue'),(global.lastValue));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/onSale'),(global.onSale));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/rentapotent'),(global.lastValue-global.priceAchat));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/teamUrl'),(global.teamUrl));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/team'),(global.team));
      set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/noteSorareManger'),(global.noteSorareManger));
  
  
  
      if(global.priceAchat!=0){
        set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/rentapotentPercent'),(((global.lastValue-global.priceAchat))/global.priceAchat)*100);
      }else{set(ref(getDatabase(), global.user+'/mycards/card/'+i+'/rentapotentPercent'),(100))}
  
    }
    
        const allValue= tabAllValue.reduce(reducer).toFixed(3);
        set(ref(getDatabase(), global.user+'/profil/watching/totalValueWallet'),(+allValue));  
    ...
    for(let i =0; i<nbAuctions; i++){
      ...
      set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/cardName'),(cardName));
      set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/currentPrice'),(currentPrice));
      set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/endDate'),(endDate));
      set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/id'),(id));
      set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/creditCardFee'),(creditCardFee));
      for(let g =0;g<nbCardsAuction;g++){
        ...
        set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/auctionCards/'+g+'/cardSlug'),(cardSlug));
        set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/auctionCards/'+g+'/cardPicture'),(cardPicture));
        set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/auctionCards/'+g+'/playerSlug'),(playerSlug));
        set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/auctionCards/'+g+'/playerName'),(playerName));
        set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/auctionCards/'+g+'/position'),(position));
        set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/auctionCards/'+g+'/rarete'),(rarete));
        set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/auctionCards/'+g+'/age'),(age));
      }
      ...
      set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/teamSlug'),(global.teamSlug));
      set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/team'),(global.team));
      set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/teamUrl'),(global.teamUrl));
      set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/leagueslug'),(global.leagueslug));
      set(ref(getDatabase(), global.user+'/myauctions/auction/'+i+'/competition'),(global.competition));
    }
  
      const allAuctions= tabAllAuctions.reduce(reducer).toFixed(3);
      set(ref(getDatabase(), global.user+'/profil/watching/totalAuctions'),(+allAuctions));  
    ...
    for(let i=0; i<nbOfferSReceived; i++){
      ...
      tabBalanceSent.push((sendWeiAmount-receiveWeiAmount)/Math.pow(10,18));
        ...
        set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/transfert'),("sent"));
        set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/id'),(id));
        set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/creditCardFee'),(creditCardFee));
        set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/acceptedAt'),(acceptedAt));
        set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receiveWeiAmount'),(sendWeiAmount/Math.pow(10,18)));
        set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sendWeiAmount'),(receiveWeiAmount/Math.pow(10,18)));
        set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/balance'),((sendWeiAmount-receiveWeiAmount)/Math.pow(10,18)));
  
  
        set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/nbOffertCards'),(nbOffertSentCards));
        if(userOfferReceived[i].receiveCardOffers!=null){
          for(let g=0; g<nbOffertReceiveCards;g++){
            ...
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/id'),(id));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/id'),(id));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/rarete'),(rarete));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/age'),(age));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/cardSlug'),(cardSlug));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/cardName'),(cardName));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/cardPicture'),(cardPicture));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/displayName'),(displayName));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/playerSlug'),(playerSlug));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/position'),(position));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/transfert'),("received"));
            ...
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/teamSlug'),(global.teamSlug));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/team'),(global.team));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/teamUrl'),(global.teamUrl));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/leagueslug'),(global.leagueslug));
            set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/receivedCards/'+g+'/competition'),(global.competition));
          }
        }
          if(userOfferReceived[i].sendCardOffers!=null){
            for(let g=0; g<nbOffertSentCards;g++){
              ...
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/id'),(id));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/id'),(id));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/rarete'),(rarete));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/age'),(age));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/cardSlug'),(cardSlug));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/cardName'),(cardName));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/cardPicture'),(cardPicture));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/displayName'),(displayName));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/playerSlug'),(playerSlug));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/position'),(position));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/transfert'),("sent"));
              ...
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/teamSlug'),(global.teamSlug));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/team'),(global.team));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/teamUrl'),(global.teamUrl));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/leagueslug'),(global.leagueslug));
              set(ref(getDatabase(), global.user+'/mydirectoffers/sent/'+f+'/sentCards/'+g+'/competition'),(global.competition));
          ...
          set(ref(getDatabase(), global.user+'/profil/watching/balanceSent'),(+allBalanceSent));
    ...
    for(let i=0; i<nbOfferSent; i++){
      ...
      tabBalanceReceived.push((receiveWeiAmount-sendWeiAmount)/Math.pow(10,18));
        ...
        set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/transfert'),("received"));
        set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/id'),(id));
        set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/creditCardFee'),(creditCardFee));
        set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/acceptedAt'),(acceptedAt));
        set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sendWeiAmount'),(sendWeiAmount/Math.pow(10,18)));
        set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receiveWeiAmount'),(receiveWeiAmount/Math.pow(10,18)));
        set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/balance'),((receiveWeiAmount-sendWeiAmount)/Math.pow(10,18)));
        set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/nbOffertCards'),(nbOffertSentCards));
        if(userOfferSent[i].receiveCardOffers!=null){
          for(let g=0; g<nbOffertReceiveCards;g++){
            ...
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/id'),(id));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/id'),(id));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/rarete'),(rarete));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/age'),(age));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/cardSlug'),(cardSlug));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/cardName'),(cardName));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/cardPicture'),(cardPicture));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/displayName'),(displayName));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/playerSlug'),(playerSlug));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/position'),(position));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/transfert'),("received"));
            ...
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/teamSlug'),(global.teamSlug));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/team'),(global.team));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/teamUrl'),(global.teamUrl));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/leagueslug'),(global.leagueslug));
            set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/receivedCards/'+g+'/competition'),(global.competition));
          }
        }
          if(userOfferSent[i].sendCardOffers!=null){
            for(let g=0; g<nbOffertSentCards;g++){
              ...
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/id'),(id));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/id'),(id));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/rarete'),(rarete));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/age'),(age));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/cardSlug'),(cardSlug));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/cardName'),(cardName));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/cardPicture'),(cardPicture));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/displayName'),(displayName));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/playerSlug'),(playerSlug));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/position'),(position));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/transfert'),("sent"));
              ...
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/teamSlug'),(global.teamSlug));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/team'),(global.team));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/teamUrl'),(global.teamUrl));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/leagueslug'),(global.leagueslug));
              set(ref(getDatabase(), global.user+'/mydirectoffers/received/'+h+'/sentCards/'+g+'/competition'),(global.competition));
        ...
        set(ref(getDatabase(), global.user+'/profil/watching/balanceReceived'),(+allBalanceReceived));
...
// ################################################################
// #########################  REFRESH PLAYERS   ######################
var myJob1 = new CronJob('0 2 * * *', async function(){
  async function main(this:any) {
    const endpoint = 'https://api.sorare.com/graphql'
    const graphQLClient = new GraphQLClient(endpoint, {
      headers: {
...
router.get('/api/refreshlast', async (req,res) => {
  const db = getFirestore();
  const dbRef = ref(getDatabase());
  var tabUsers: any[] =[];
  const querySnapshot = await getDocs(collection(db, "users"));
  ...
  let count = -1;
    ...
    `;
          ...
          if(global.rewards === true){
            ...
            set(ref(getDatabase(), user+'/profil/watching/totalRewards'),(+totalRewards));  
          ...
          set(ref(getDatabase(), user+'/myrewards/'),(myRewards));
        }, 30000);
          ...
          do{
            ...
            variables = {
              ...
              const auctions = await graphQLClient.request(GET_AUCTIONS_CURRENT_USER,variables);
        ...
        if( global.auctions === true){
          ...
          do{
            ...
            variables = {
              ...
              const userOfferWallet = await graphQLClient.request(GET_DIRECT_OFFER_RECEIVE_CURRENT_USER,variables);
          ...
          do{
            ...
            variables = {
              ...
              const userOfferSentWallet = await graphQLClient.request(GET_DIRECT_OFFER_SENT_CURRENT_USER,variables);
            ...
            axios.get('https://min-api.cryptocompare.com/data/price?fsym=ETH&tsyms=EUR,USD&api_key=3407e811098c81482681d5f96768abacdaa1d3415dfd6f0befe66550a44b65a3').then(resp => {  
              ...
              onValue(ref(getDatabase(), user+'/profil/'), (snapshot:DataSnapshot) => {
                ...
                set(ref(getDatabase(), user+'/profil/historique/'+nbHistory+'/date'),(Date()));
                  ...
                  set(ref(getDatabase(), user+'/profil/historique/0/totalValueWallet'),(0));
                  set(ref(getDatabase(), user+'/profil/historique/0/totalWallet'),(0));
                  set(ref(getDatabase(), user+'/profil/historique/0/totalRewards'),(0));
                  set(ref(getDatabase(), user+'/profil/historique/0/ethValue'),(resp.data));
